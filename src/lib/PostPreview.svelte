...
<a class="group relative" href={`${post.url}`}>
  <article
  ...
  >
    ...
    >
      ...
      >
        <h3 class="text-xl font-bold tracking-wider underline sm:no-underline">
          {post.title}
        </h3>
  ...
  <div
    class="w-full h-full translate-y-1 fancy-gradient shadow absolute rounded bg-red-500 top-0 left-0"
  />
</a>
